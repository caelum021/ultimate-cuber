...
export const LANGUAGES: { code: Language; label: string }[] = [
  ...
  { code: "id", label: "Bahasa Indonesia/Bahasa Melayu 🇮🇩🇲🇾" },
...
const en = {
  ...
  settings: {
    ...
    soundEffectsDesc: "Play a beep when the timer starts and stops, and a victory jingle for a new personal best.",
    theme: "Theme",
    ...
    exportSolves: "Export solves",
    exportSolvesDesc: "Download all your solves as a backup file. Your times only live in this browser, so save one now and then.",
    exportBtn: "Export",
    importSolves: "Import solves",
    importSolvesDesc: "Load a backup file. Solves are added to the ones you have — nothing gets overwritten.",
    importBtn: "Import",
    importDone: "Imported {n} solves.",
    importNone: "Nothing new — you already have every solve in that file.",
    importError: "That file isn't a solves backup.",
  },
  learn: {
...
const es: Dict = {
  ...
  settings: {
    ...
    soundEffectsDesc: "Reproduce un pitido al iniciar y detener el cronómetro, y un sonido de victoria para un nuevo récord.",
    theme: "Tema",
    ...
    exportSolves: "Exportar resoluciones",
    exportSolvesDesc: "Descarga todas tus resoluciones como copia de seguridad. Tus tiempos solo se guardan en este navegador, así que haz una de vez en cuando.",
    exportBtn: "Exportar",
    importSolves: "Importar resoluciones",
    importSolvesDesc: "Carga una copia de seguridad. Las resoluciones se suman a las que ya tienes; no se sobrescribe nada.",
    importBtn: "Importar",
    importDone: "Se importaron {n} resoluciones.",
    importNone: "Nada nuevo: ya tienes todas las resoluciones de ese archivo.",
    importError: "Ese archivo no es una copia de seguridad de resoluciones.",
  },
  learn: {
...
const fr: Dict = {
  ...
  settings: {
    ...
    soundEffectsDesc: "Joue un bip au démarrage et à l'arrêt du chrono, et un son de victoire pour un nouveau record.",
    theme: "Thème",
    ...
    exportSolves: "Exporter les résolutions",
    exportSolvesDesc: "Télécharge toutes tes résolutions dans un fichier de sauvegarde. Tes temps ne sont stockés que dans ce navigateur, alors sauvegarde-les de temps en temps.",
    exportBtn: "Exporter",
    importSolves: "Importer des résolutions",
    importSolvesDesc: "Charge un fichier de sauvegarde. Les résolutions s’ajoutent aux tiennes — rien n’est écrasé.",
    importBtn: "Importer",
    importDone: "{n} résolutions importées.",
    importNone: "Rien de nouveau : tu as déjà toutes les résolutions de ce fichier.",
    importError: "Ce fichier n’est pas une sauvegarde de résolutions.",
  },
  learn: {
...
const gib: Dict = {
  ...
  settings: {
    ...
    soundEffects: "Soundz Effectz",
    soundEffectsDesc: "Playz a beepz when da tïmzø startz and stopz, and a winz jinglz for a new bestz.",
    theme: "Themez",
    ...
    dataSection: "Ur dataz",
    exportSolves: "Exportz solvez",
    exportSolvesDesc: "Downloadz all ur solvez az backupz filez. timez only liv in dis browsr so savez sumtimez.",
    exportBtn: "Exportz",
    importSolves: "Importz solvez",
    importSolvesDesc: "Loadz backupz filez. solvez get addz, nothin getz yeetz.",
    importBtn: "Importz",
    importDone: "Importz {n} solvez. W.",
    importNone: "Nothin newz — u alredy hav all dem solvez.",
    importError: "Dat filez aint no solvez backupz. L.",
  },
  learn: {
    hubTitle: "Lernz cave 🦇",
    hubIntro:
...
const ko: Dict = {
  ...
  settings: {
    ...
    soundEffects: "효과음",
    soundEffectsDesc: "타이머가 시작하고 멈출 때 삐 소리, 새 최고 기록에는 축하 소리를 재생합니다.",
    theme: "테마",
    ...
    dataSection: "내 데이터",
    exportSolves: "기록 내보내기",
    exportSolvesDesc: "모든 솔브 기록을 백업 파일로 내려받아요. 기록은 이 브라우저에만 저장되니 가끔 백업해 두세요.",
    exportBtn: "내보내기",
    importSolves: "기록 가져오기",
    importSolvesDesc: "백업 파일을 불러와요. 지금 기록에 추가되고, 덮어쓰지는 않아요.",
    importBtn: "가져오기",
    importDone: "기록 {n}개를 가져왔어요.",
    importNone: "새 기록이 없어요. 이 파일의 기록은 이미 모두 있어요.",
    importError: "솔브 기록 백업 파일이 아니에요.",
  },
  learn: {
    hubTitle: "학습 허브",
    hubIntro:
...
const zh: Dict = {
  ...
  settings: {
    ...
    soundEffects: "音效",
    soundEffectsDesc: "计时器开始和停止时播放提示音，创造新纪录时播放胜利音效。",
    theme: "主题",
    ...
    dataSection: "我的数据",
    exportSolves: "导出成绩",
    exportSolvesDesc: "将所有成绩下载为备份文件。成绩只保存在此浏览器中，记得时常备份。",
    exportBtn: "导出",
    importSolves: "导入成绩",
    importSolvesDesc: "加载备份文件。成绩会添加到现有记录中，不会覆盖任何内容。",
    importBtn: "导入",
    importDone: "已导入 {n} 条成绩。",
    importNone: "没有新内容——该文件中的成绩你都已经有了。",
    importError: "该文件不是成绩备份。",
  },
  learn: {
    hubTitle: "学习中心",
    hubIntro:
...
const ja: Dict = {
  ...
  settings: {
    ...
    soundEffects: "効果音",
    soundEffectsDesc: "タイマーの開始と停止時にビープ音、自己ベスト更新時に勝利音を再生します。",
    theme: "テーマ",
    ...
    dataSection: "データ",
    exportSolves: "記録をエクスポート",
    exportSolvesDesc: "すべてのソルブ記録をバックアップファイルとしてダウンロードします。記録はこのブラウザにしか保存されないので、ときどき保存しましょう。",
    exportBtn: "エクスポート",
    importSolves: "記録をインポート",
    importSolvesDesc: "バックアップファイルを読み込みます。今の記録に追加され、上書きはされません。",
    importBtn: "インポート",
    importDone: "{n} 件の記録をインポートしました。",
    importNone: "新しい記録はありません。このファイルの記録はすべて登録済みです。",
    importError: "ソルブ記録のバックアップファイルではありません。",
  },
  learn: {
    hubTitle: "学習ハブ",
    hubIntro:
...
const idn: Dict = {
  nav: { timer: "Timer", learn: "Belajar", train: "Latihan", settings: "Pengaturan" },
  home: {
    eyebrow: "Jalanmu menuju sub-20 dan lebih cepat lagi",
    title: "Teman speedcubing terbaik",
    subtitle:
      "Timer gaya WCA yang cepat dan mencatat setiap solve — ao5, ao12, dan PB-mu — plus pusat belajar untuk menguasai OLL, PLL, dan F2L.",
    ctaTimer: "Mulai timer →",
    ctaLearn: "Jelajahi pusat belajar",
    feat1Title: "Scramble baru",
    feat1Body:
      "Scramble 3×3 acak yang baru di setiap solve, dibuat langsung di browser-mu — tanpa menunggu, bisa offline.",
    feat2Title: "Statistik pintar",
    feat2Body:
      "ao5 / ao12 / ao100 langsung, rata-rata sesi, dan waktu terbaik — dengan penanganan +2 dan DNF yang benar di setiap solve.",
    feat3Title: "Belajar untuk berkembang",
    feat3Body:
      "Panduan terstruktur dan set algoritma untuk OLL, PLL, dan F2L, jadi kamu selalu tahu apa yang harus dilatih berikutnya.",
    subTitle: "Subscribe Ultimate Cuber di YouTube",
    subBody:
      "Tutorial, penjelasan algoritma, dan tips — dari metode pemula sampai sub-20. Video baru untuk membantumu berkembang.",
    subBtn: "Subscribe di YouTube",
    feedbackBtn: "Masukan",
    feedbackTitle: "Kirim masukan",
    feedbackDesc: "Menemukan bug atau punya ide? Kami ingin mendengarnya.",
    feedbackPlaceholder: "Tulis masukanmu di sini…",
    feedbackSend: "Kirim",
  ...
  timer: {
    scramble: "Scramble · 3×3",
    holdBefore: "Tahan",
    holdAfter: "(atau sentuh & tahan), lepas untuk mulai",
    typingMode: "Mode ketik",
    inspectionOn: "Inspeksi 15 dtk",
    clearSession: "Hapus sesi",
    clearConfirm: "Hapus semua solve di sesi ini? Tindakan ini tidak bisa dibatalkan.",
    addSolve: "Tambah solve",
    typingHintPre: "Tidak perlu titik — misalnya ketik",
    typingHintPost: ". Pakai titik juga bisa.",
    errorPre: "Masukkan waktu yang valid, misalnya",
    noSolvesPre: "Belum ada solve. Tahan",
    noSolvesPost: "untuk bersiap, lepas untuk mulai.",
    progressTitle: "Perkembangan",
  },
  settings: {
    title: "Pengaturan",
    subtitle: "Perubahan tersimpan otomatis dan berlaku di seluruh situs pada perangkat ini.",
    timerSection: "Timer",
    appearanceSection: "Tampilan",
    timingMethod: "Metode pencatatan waktu",
    timingMethodDesc:
      "Timer: tahan spasi / ketuk untuk mencatat waktu di layar. Ketik: pakai timer fisikmu sendiri lalu ketik hasilnya.",
    timerLabel: "Timer",
    typingLabel: "Ketik",
    inspection: "Inspeksi 15 detik",
    inspectionDesc: "Hitung mundur inspeksi gaya WCA sebelum setiap solve, dengan penalti +2 / DNF.",
    scrambleLength: "Panjang scramble",
    scrambleLengthDesc: "Jumlah gerakan di setiap scramble 3×3 yang dibuat.",
    hideWhileSolving: "Sembunyikan waktu saat solve",
    hideWhileSolvingDesc:
      "Menampilkan “solving…” alih-alih waktu yang berjalan, lalu menampilkannya saat kamu berhenti.",
    showMs: "Tampilkan milidetik",
    showMsDesc: "Tampilkan 3 desimal (12.345) alih-alih standar 2 desimal (12.34).",
    soundEffects: "Efek suara",
    soundEffectsDesc: "Bunyi beep saat timer mulai dan berhenti, dan jingle kemenangan untuk rekor pribadi baru.",
    theme: "Tema",
    themeDesc: "Ganti antara gelap dan terang di seluruh situs.",
    dark: "Gelap",
    light: "Terang",
    language: "Bahasa",
    languageDesc: "Pilih bahasa situs.",
    reset: "Kembalikan semua pengaturan ke default",
    dataSection: "Datamu",
    exportSolves: "Ekspor solve",
    exportSolvesDesc: "Unduh semua solve-mu sebagai file cadangan. Waktumu hanya tersimpan di browser ini, jadi simpan cadangan sesekali.",
    exportBtn: "Ekspor",
    importSolves: "Impor solve",
    importSolvesDesc: "Muat file cadangan. Solve ditambahkan ke yang sudah ada — tidak ada yang tertimpa.",
    importBtn: "Impor",
    importDone: "{n} solve berhasil diimpor.",
    importNone: "Tidak ada yang baru — semua solve di file itu sudah kamu punya.",
    importError: "File itu bukan cadangan solve.",
  },
  learn: {
    hubTitle: "Pusat belajar",
    hubIntro:
      "Semua yang kamu butuhkan dari metode pemula sampai solve CFOP sub-20. Mulai dari gambaran umum, latih F2L, lalu pelajari 2-look OLL dan PLL.",
    secOLL: "2-Look OLL",
    secPLL: "2-Look PLL",
    secLevelUp: "Naik level",
    secWVLS: "CFOP lanjutan: WVLS",
    secRoux: "Metode alternatif: Roux",
    sec2x2: "Kubus 2×2",
    sec2x2Intro:
      "Baru mengenal kubus? 2×2 adalah tempat paling ramah untuk mulai. Pelajari metode pemula dulu, lalu percepat dengan Ortega.",
    notation:
      "Notasi: R U F = putaran sisi searah jarum jam, R' = berlawanan arah jarum jam, R2 = 180°. Huruf kecil (r, f) dan M adalah gerakan lebar/irisan.",
    notationGuide: "Baca panduan notasi lengkap",
    learnMore: "Pelajari lebih lanjut",
    viewAllOLL: "Lihat semua 57 algoritma OLL",
    viewAllPLL: "Lihat semua 21 algoritma PLL",
    viewAllWVLS: "Lihat semua 27 algoritma WV",
    viewAllCMLL: "Lihat semua 42 algoritma CMLL",
    viewAll2x2: "Lihat semua algoritma 2×2",
    openFull2x2: "Buka panduan 2×2 lengkap",
    watchHeading: "Kalau ingin belajar Metode Pemula, klik tautan di bawah ini.",
    watchBtn: "Tonton di YouTube",
    backToHub: "← Kembali ke pusat belajar",
  },
  train: {
    title: "Pusat latihan",
    subtitle: "Pilih set, lihat kasusnya, dan sebutkan namanya — lalu periksa jawabanmu.",
    choose: "Set latihan",
    selectOne: "Pilih setidaknya satu set untuk dilatih.",
    recall: "Coba ingat algoritmanya…",
    reveal: "Tampilkan jawaban",
    next: "Kasus berikutnya →",
    typePlaceholder: "Ketik nama kasus…",
    check: "Periksa",
    correct: "Benar! ✓",
    wrong: "Belum tepat — coba lagi, atau tampilkan jawaban.",
    practiced: "Dilatih",
    hint: "Tips: tekan Spasi atau Enter untuk menampilkan jawaban, lalu sekali lagi untuk kasus berikutnya.",
    setFullOLL: "OLL lengkap",
    setFullPLL: "PLL lengkap",
    set2LookOLL: "2-Look OLL",
    set2LookPLL: "2-Look PLL",
    setWVLS: "WVLS",
    setCMLL: "CMLL",
    set2x2OLL: "OLL 2×2",
    set2x2PBL: "PBL 2×2",
    setupScramble: "Scramble persiapan",
    setupHint: "Lakukan ini pada kubus yang sudah jadi untuk membuat kasusnya, lalu selesaikan dengan algoritma.",
  },
};

const pt: Dict = {
  nav: { timer: "Timer", learn: "Aprender", train: "Treinar", settings: "Configurações" },
  home: {
    eyebrow: "Seu caminho para o sub-20 e além",
    title: "O companheiro definitivo do speedcubing",
    subtitle:
      "Um timer rápido no estilo WCA que registra cada solve — ao5, ao12 e seu PB — além de uma central de aprendizado para dominar OLL, PLL e F2L.",
    ctaTimer: "Começar a cronometrar →",
    ctaLearn: "Explorar a central de aprendizado",
    feat1Title: "Scrambles novos",
    feat1Body:
      "Um novo scramble 3×3 aleatório a cada solve, gerado na hora no seu navegador — sem espera, funciona offline.",
    feat2Title: "Estatísticas inteligentes",
    feat2Body:
      "ao5 / ao12 / ao100 ao vivo, média da sessão e melhor tempo — com tratamento correto de +2 e DNF em cada solve.",
    feat3Title: "Aprenda a evoluir",
    feat3Body:
      "Guias estruturados e conjuntos de algoritmos de OLL, PLL e F2L para você sempre saber o que treinar em seguida.",
    subTitle: "Inscreva-se no Ultimate Cuber no YouTube",
    subBody:
      "Tutoriais, explicações de algoritmos e dicas — do método para iniciantes até o sub-20. Vídeos novos para ajudar você a evoluir.",
    subBtn: "Inscrever-se no YouTube",
    feedbackBtn: "Feedback",
    feedbackTitle: "Envie seu feedback",
    feedbackDesc: "Encontrou um bug ou tem uma ideia? Adoraríamos saber.",
  ...
  timer: {
    scramble: "Scramble · 3×3",
    holdBefore: "Segure",
    holdAfter: "(ou toque e segure), solte para começar",
    typingMode: "Modo digitação",
    inspectionOn: "Inspeção de 15s",
    clearSession: "Limpar sessão",
    clearConfirm: "Apagar todos os solves desta sessão? Isso não pode ser desfeito.",
    addSolve: "Adicionar solve",
    typingHintPre: "Não precisa de ponto — por exemplo, digite",
    typingHintPost: ". Com ponto também funciona.",
    errorPre: "Digite um tempo válido, por exemplo",
    noSolvesPre: "Nenhum solve ainda. Segure",
    noSolvesPost: "para se preparar, solte para começar.",
    progressTitle: "Progresso",
  },
  settings: {
    title: "Configurações",
    subtitle: "As alterações são salvas automaticamente e valem em todo o site neste dispositivo.",
    timerSection: "Timer",
    appearanceSection: "Aparência",
    timingMethod: "Método de cronometragem",
    timingMethodDesc:
      "Timer: segure espaço / toque para cronometrar na tela. Digitação: use seu próprio timer físico e digite o resultado.",
    timerLabel: "Timer",
    typingLabel: "Digitação",
    inspection: "Inspeção de 15 segundos",
    inspectionDesc: "Contagem regressiva de inspeção no estilo WCA antes de cada solve, com penalidades +2 / DNF.",
    scrambleLength: "Tamanho do scramble",
    scrambleLengthDesc: "Número de movimentos em cada scramble 3×3 gerado.",
    hideWhileSolving: "Esconder o tempo durante o solve",
    hideWhileSolvingDesc:
      "Mostra “solving…” em vez do tempo correndo e revela o tempo quando você para.",
    showMs: "Mostrar milissegundos",
    showMsDesc: "Mostra 3 casas decimais (12.345) em vez das 2 padrão (12.34).",
    soundEffects: "Efeitos sonoros",
    soundEffectsDesc: "Toca um bipe quando o timer começa e para, e uma música de vitória para um novo recorde pessoal.",
    theme: "Tema",
    themeDesc: "Alterne entre escuro e claro em todo o site.",
    dark: "Escuro",
    light: "Claro",
    language: "Idioma",
    languageDesc: "Escolha o idioma do site.",
    reset: "Restaurar todas as configurações padrão",
    dataSection: "Seus dados",
    exportSolves: "Exportar solves",
    exportSolvesDesc: "Baixe todos os seus solves como arquivo de backup. Seus tempos ficam só neste navegador, então salve um de vez em quando.",
    exportBtn: "Exportar",
    importSolves: "Importar solves",
    importSolvesDesc: "Carregue um arquivo de backup. Os solves são somados aos que você já tem — nada é sobrescrito.",
    importBtn: "Importar",
    importDone: "{n} solves importados.",
    importNone: "Nada novo — você já tem todos os solves desse arquivo.",
    importError: "Esse arquivo não é um backup de solves.",
  },
  learn: {
    hubTitle: "Central de aprendizado",
    hubIntro:
      "Tudo o que você precisa para ir do método para iniciantes a um solve CFOP sub-20. Comece pela visão geral, treine o F2L e depois aprenda o OLL e o PLL em 2 looks.",
    secOLL: "OLL em 2 looks",
    secPLL: "PLL em 2 looks",
    secLevelUp: "Subindo de nível",
    secWVLS: "CFOP avançado: WVLS",
    secRoux: "Método alternativo: Roux",
    sec2x2: "Cubo 2×2",
    sec2x2Intro:
      "Começando no cubo? O 2×2 é o lugar mais tranquilo para começar. Aprenda primeiro o método para iniciantes e depois acelere com o Ortega.",
    notation:
      "Notação: R U F = giros das faces no sentido horário, R' = anti-horário, R2 = 180°. Minúsculas (r, f) e M são movimentos largos/de camada do meio.",
    notationGuide: "Leia o guia completo de notação",
    learnMore: "Saiba mais",
    viewAllOLL: "Ver todos os 57 algoritmos de OLL",
    viewAllPLL: "Ver todos os 21 algoritmos de PLL",
    viewAllWVLS: "Ver todos os 27 algoritmos de WV",
    viewAllCMLL: "Ver todos os 42 algoritmos de CMLL",
    viewAll2x2: "Ver todos os algoritmos de 2×2",
    openFull2x2: "Abrir o guia completo de 2×2",
    watchHeading: "Se você quer aprender o Método para Iniciantes, clique no link abaixo.",
    watchBtn: "Assistir no YouTube",
    backToHub: "← Voltar para a central de aprendizado",
  },
  train: {
    title: "Central de treino",
    subtitle: "Escolha um conjunto, olhe o caso e diga o nome — depois confira.",
    choose: "Conjuntos de treino",
    selectOne: "Selecione pelo menos um conjunto para treinar.",
    recall: "Tente lembrar o algoritmo…",
    reveal: "Mostrar resposta",
    next: "Próximo caso →",
    typePlaceholder: "Digite o nome do caso…",
    check: "Conferir",
    correct: "Correto! ✓",
    wrong: "Quase — tente de novo ou mostre a resposta.",
    practiced: "Treinados",
    hint: "Dica: aperte Espaço ou Enter para mostrar a resposta e de novo para o próximo caso.",
    setFullOLL: "OLL completo",
    setFullPLL: "PLL completo",
    set2LookOLL: "OLL em 2 looks",
    set2LookPLL: "PLL em 2 looks",
    setWVLS: "WVLS",
    setCMLL: "CMLL",
    set2x2OLL: "OLL de 2×2",
    set2x2PBL: "PBL de 2×2",
    setupScramble: "Scramble de preparação",
    setupHint: "Faça isso num cubo resolvido para montar o caso e depois resolva com o algoritmo.",
  },
};
